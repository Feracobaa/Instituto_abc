...
vi.mock("@/hooks/school/useAcademicData", () => ({
...
describe("AcademicPeriodsManager", () => {
  it("muestra el estado activo e inactivo de los bimestres", () => {
    ...
    expect(screen.getByText("Control de Periodos")).toBeInTheDocument();
  ...
  it("advierte cuando no existe ningun bimestre activo", () => {
    ...
    expect(screen.getByText(/No hay ningún periodo activo/)).toBeInTheDocument();
  });
});
