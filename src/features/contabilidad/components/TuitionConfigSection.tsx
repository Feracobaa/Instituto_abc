          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div className="space-y-1">
              <h4 className="text-sm font-bold text-foreground flex items-center gap-1.5">
                <span className={`h-2 w-2 rounded-full bg-amber-500 ${settings?.allow_reports_on_debt_temp ? "animate-pulse" : ""}`} />
            ...
            <div className="flex items-center gap-2 shrink-0">
              <Button
                variant={settings?.allow_reports_on_debt_temp ? "destructive" : "default"}
                onClick={async () => {
                  try {
                    ...
                    // Toast error is handled inside useUpdateInstitutionSettings mutation hook
                  }
                }}
              ...
              >
                ...
                ) : settings?.allow_reports_on_debt_temp ? (
